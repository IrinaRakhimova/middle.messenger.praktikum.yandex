...
export class ChatsPage extends Block {
  ...
  public afterRender(): void {
    ...
    const form =
      this.getContent()?.querySelector<HTMLFormElement>("#chat-form");
  ...
  private handleSend(): void {
    const input = this.getContent()?.querySelector<HTMLInputElement>(
      'input[name="message"]'
    );
  ...
  protected componentWillUnmount(): void {
    // eslint-disable-next-line no-console
    console.log("ChatsPage is being destroyed");
  }
}
